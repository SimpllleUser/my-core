      ...
      <VCol cols="12" md="8" lg="6">
        ...
        <div class="mb-16">
          ...
          <div class="d-flex justify-center ga-4">
            <VBtn color="primary" size="large" :prepend-icon="Icons.Home" @click="goHome">
              Go Home
            </VBtn>
            <VBtn variant="outlined" size="large" :prepend-icon="Icons.ArrowLeft" @click="goBack">
              Go Back
            </VBtn>
          </div>
        </div>
        ...
        <div class="mb-16">
          <VIcon size="160" color="primary" class="mb-6">{{ Icons.FileSearch }}</VIcon>
        ...
        <div>
          <div class="text-h1 font-weight-bold mb-4" style="font-size: 120px !important;">
            ...
            <VIcon size="100" color="error" class="mx-n2">{{ Icons.EmoticonSad }}</VIcon>
            <span class="text-primary">4</span>
          </div>
